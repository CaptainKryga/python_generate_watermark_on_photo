...
if __name__ == '__main__':
	...
	if (sys.argv[1] == "-h"):
		...
		print(">>> стандартный формат файлов jpeg, для замены в командной строке допиши вот это")
		print("-f${формат файлов}")
		print(">>> стандартный шрифт должен быть в папке и называется font.ttf, для замены в командной строке допиши вот это")
		print("-t${название и путь к шрифту полностью}")
		print(">>> стандартная ватермарка должна быть в папке и называтся watermark.jpg, для замены в командной строке допиши вот это")
